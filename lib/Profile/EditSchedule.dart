...
import 'package:flutter_app/Model/AppointmentTest.dart';
...
class _EditScheduleState extends State<EditSchedule> {
  ...
  Appointment shedule = Appointment();
  bool _shedule = false;
...
// to side validation
  ...
  void fetchData() async {
    var response = await networkHandler.get(getShedule);
     setState(() {
      ...
      body: circular ? Center(child: CircularProgressIndicator()) : ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
                  "There won't be any changes for the days where appointment is already booked",
              textAlign: TextAlign.center,
  ...
  slotprint(int x) async{
...

    {
      ...
      var response = await networkHandler.patch1(
          sheduleUpdate, appointment.toJson());
      print("5");
